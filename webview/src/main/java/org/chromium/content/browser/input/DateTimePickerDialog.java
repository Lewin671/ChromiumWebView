...
class DateTimePickerDialog extends AlertDialog implements OnClickListener,
    ...
    public DateTimePickerDialog(Context context,
        ...
        setButton(BUTTON_POSITIVE, context.getText(
                R1.string.date_picker_dialog_set), this);
        setButton(BUTTON_NEGATIVE, context.getText(android.R.string.cancel),
                (OnClickListener) null);
        setIcon(0);
        setTitle(context.getText(R1.string.date_time_picker_dialog_title));

        LayoutInflater inflater =
                (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R1.layout.date_time_picker_dialog, null);
        setView(view);
        mDatePicker = (DatePicker) view.findViewById(R1.id.date_picker);
        ...
        mTimePicker = (TimePicker) view.findViewById(R1.id.time_picker);
