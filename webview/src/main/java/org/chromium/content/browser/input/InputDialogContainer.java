...
public class InputDialogContainer {
    ...
    void showSuggestionDialog(final int dialogType,
        ...
        int dialogTitleId = R1.string.date_picker_dialog_title;
        if (dialogType == sTextInputTypeTime) {
            dialogTitleId = R1.string.time_picker_dialog_title;
        } else if (dialogType == sTextInputTypeDateTime ||
                dialogType == sTextInputTypeDateTimeLocal) {
            dialogTitleId = R1.string.date_time_picker_dialog_title;
        } else if (dialogType == sTextInputTypeMonth) {
            dialogTitleId = R1.string.month_picker_dialog_title;
        } else if (dialogType == sTextInputTypeWeek) {
            dialogTitleId = R1.string.week_picker_dialog_title;
        }
    ...
    void showPickerDialog(final int dialogType,
        ...
        if (dialogType == sTextInputTypeDate) {
            ...
            dialog.setTitle(mContext.getText(R1.string.date_picker_dialog_title));
            mDialog = dialog;
        } else if (dialogType == sTextInputTypeTime) {
        ...
        mDialog.setButton(DialogInterface.BUTTON_POSITIVE,
                mContext.getText(R1.string.date_picker_dialog_set),
        ...
        mDialog.setButton(DialogInterface.BUTTON_NEUTRAL,
                mContext.getText(R1.string.date_picker_dialog_clear),
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        mDialogAlreadyDismissed = true;
