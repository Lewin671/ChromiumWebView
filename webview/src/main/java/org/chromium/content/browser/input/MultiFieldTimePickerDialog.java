...
public class MultiFieldTimePickerDialog
    ...
    public MultiFieldTimePickerDialog(
        ...
        View view = inflater.inflate(R1.layout.multi_field_time_picker_dialog, null);
        setView(view);

        mHourSpinner = (NumberPicker) view.findViewById(R1.id.hour);
        mMinuteSpinner = (NumberPicker) view.findViewById(R1.id.minute);
        mSecSpinner = (NumberPicker) view.findViewById(R1.id.second);
        mMilliSpinner = (NumberPicker) view.findViewById(R1.id.milli);
        mAmPmSpinner = (NumberPicker) view.findViewById(R1.id.ampm);
        ...
        if (is24hourFormat) {
            ...
            mAmPmSpinner.setDisplayedValues(new String[] {
                    context.getString(R1.string.time_picker_dialog_am),
                    context.getString(R1.string.time_picker_dialog_pm)
            });
        ...
        if (step >= MINUTE_IN_MILLIS) {
            ...
            view.findViewById(R1.id.second_colon).setVisibility(View.GONE);
        ...
        if (step >= SECOND_IN_MILLIS) {
            ...
            view.findViewById(R1.id.second_dot).setVisibility(View.GONE);
