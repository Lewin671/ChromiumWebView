...
public class ColorPickerAdvanced extends LinearLayout implements OnSeekBarChangeListener {
    ...
    private void init() {
        ...
        mHueDetails = createAndAddNewGradient(R1.string.color_picker_hue,
                HUE_SEEK_BAR_MAX, this);
        mSaturationDetails = createAndAddNewGradient(R1.string.color_picker_saturation,
                SATURATION_SEEK_BAR_MAX, this);
        mValueDetails = createAndAddNewGradient(R1.string.color_picker_value,
    ...
    public ColorPickerAdvancedComponent createAndAddNewGradient(int textResourceId,
        ...
        View newComponent = inflater.inflate(R1.layout.color_picker_advanced_component, null);
