...
public class ColorPickerDialog extends AlertDialog implements OnColorChangedListener {
    ...
    public ColorPickerDialog(Context context,
        ...
        View title = inflater.inflate(R1.layout.color_picker_dialog_title, null);
        setCustomTitle(title);

        mCurrentColorView = title.findViewById(R1.id.selected_color_view);

        TextView titleText = (TextView) title.findViewById(R1.id.title);
        titleText.setText(R1.string.color_picker_dialog_title);

        // Initialize Set/Cancel buttons
        String positiveButtonText = context.getString(R1.string.color_picker_button_set);
        ...
        String negativeButtonText = context.getString(R1.string.color_picker_button_cancel);
        ...
        View content = inflater.inflate(R1.layout.color_picker_dialog_content, null);
        setView(content);

        // Initialize More button.
        mMoreButton = (Button) content.findViewById(R1.id.more_colors_button);
        ...
        mAdvancedColorPicker =
                (ColorPickerAdvanced) content.findViewById(R1.id.color_picker_advanced);
        mAdvancedColorPicker.setVisibility(View.GONE);

        // Initialize simple color view (default view).
        mSimpleColorPicker = (ColorPickerSimple) content.findViewById(R1.id.color_picker_simple);
    ...
    private void showAdvancedView() {
        ...
        View buttonBorder = findViewById(R1.id.more_colors_button_border);
        buttonBorder.setVisibility(View.GONE);

        View simpleView = findViewById(R1.id.color_picker_simple);
