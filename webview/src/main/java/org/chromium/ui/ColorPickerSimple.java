...
public class ColorPickerSimple extends ListView implements OnColorSuggestionClickListener {
    ...
    private static final int[] DEFAULT_COLOR_LABEL_IDS = {
        R1.string.color_picker_button_red,
        R1.string.color_picker_button_cyan,
        R1.string.color_picker_button_blue,
        R1.string.color_picker_button_green,
        R1.string.color_picker_button_magenta,
        R1.string.color_picker_button_yellow,
        R1.string.color_picker_button_black,
        R1.string.color_picker_button_white
    };
