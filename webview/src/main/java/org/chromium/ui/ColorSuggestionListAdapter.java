...
public class ColorSuggestionListAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    private void setUpColorButton(View button, int index) {
        ...
        GradientDrawable swatch =
                (GradientDrawable) layers.findDrawableByLayerId(R1.id.color_button_swatch);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null && convertView instanceof LinearLayout) {
            ...
            int buttonHeight =
                mContext.getResources().getDimensionPixelOffset(R1.dimen.color_button_height);
            for (int i = 0; i < COLORS_PER_ROW; ++i) {
                ...
                button.setBackgroundResource(R1.drawable.color_button_background);
