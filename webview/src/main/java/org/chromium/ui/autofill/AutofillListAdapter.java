...
public class AutofillListAdapter extends ArrayAdapter<AutofillSuggestion> {
    ...
    AutofillListAdapter(Context context,
        ...
        super(context, R1.layout.autofill_text, objects);
